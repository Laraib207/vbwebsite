...
// Full data array (keep outside component for clarity)
const products = [
  {
    slug: "soyabean-oil",
    name: "Soyabean Oil",
...
/* RotatingShowcase - Responsive Orbit Product Slider */
function RotatingShowcase({ items = [] }) {
  const n = items.length || 1;
  const [index, setIndex] = useState(0);
  ...
  // Descriptions (short summary for all devices)
  const longText = {
