...
// FIXED Rotating Showcase Component - Same style as Soybean Oil
function RotatingShowcase({ items = [] }) {
  const n = items.length || 1;
  const [index, setIndex] = useState(0);
  ...
  const longText = {
    goodness: "Veer Bharat Mustard Oil is extracted using traditional Kachi Ghani cold-press methods, preserving natural nutrients and authentic pungent flavor. Rich in omega-3 fatty acids and powerful antioxidants, perfect for authentic Indian cooking traditions.",
    benefits: "Ideal for tadka, pickling, deep frying, and massage with high smoke point. Natural antibacterial properties boost immunity, support heart health, improve digestion, and strengthen bones. Traditional remedy for joint pain and skin health.",
    rating: "Highly praised across North India for authentic aroma, consistent quality, and competitive pricing. Trusted by thousands of families for traditional recipes. Food bloggers recommend for pickle-making and authentic Indian dishes."
  };
        ...
        <div className="space-y-5 order-2 md:order-1">
          ...
          <div className="mt-4 p-5 sm:p-8 bg-white rounded-3xl shadow-xl border-2 border-amber-100">
            <h3 className="text-lg md:text-2xl font-bold mb-2 text-amber-600 flex items-center gap-2">
              <span className="w-2 h-2 bg-amber-500 rounded-full"></span> Pure Kachi Ghani
            </h3>
            ...
            <h3 className="text-lg md:text-2xl font-bold mt-5 mb-2 text-amber-600 flex items-center gap-2">
              <span className="w-2 h-2 bg-amber-500 rounded-full"></span> Health Benefits
            </h3>
            <p className="text-base text-slate-700">{longText.benefits}</p>
            <h3 className="text-lg md:text-2xl font-bold mt-5 mb-2 text-amber-600 flex items-center gap-2">
              <span className="w-2 h-2 bg-amber-500 rounded-full"></span> Customer Reviews
            </h3>
            <p className="text-base text-slate-700">{longText.rating}</p>
          </div>
          <div className="mt-5 flex items-center gap-3">
            <span className="text-2xl md:text-4xl font-black text-amber-600">₹{items[index].price}</span>
          ...
          <div className="mt-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <button className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 bg-gradient-to-r from-amber-400 via-amber-500 to-orange-600 text-white font-bold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 text-lg">
              🛒 Add to Cart
            </button>
            <button className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 border-2 border-amber-500 text-amber-600 font-bold hover:bg-amber-50 transition-all duration-300 text-lg">
              View All Products →
            </button>
          </div>
        </div>
...
// Why Choose Section with Mustard Oil Theme
function WhyChooseSection() {
  const features = [
    {
      icon: "🏆",
      title: "Traditional Kachi Ghani",
      description: "Cold-press extraction preserves natural nutrients, authentic pungent aroma, and traditional taste"
    },
    {
      icon: "🌾",
      title: "100% Pure & Natural",
      description: "No chemicals, no preservatives, no artificial additives - just pure mustard goodness from premium seeds"
    },
    {
      icon: "💪",
      title: "Rich in Omega-3",
      description: "Loaded with omega-3 fatty acids, vitamin E, and natural antioxidants for superior health benefits"
    },
    {
      icon: "🔥",
      title: "High Smoke Point",
      description: "Perfect for deep frying, tadka, pickling, and high-temperature cooking without breaking down"
    },
    {
      icon: "✅",
      title: "FSSAI Certified",
      description: "Rigorous quality checks and lab testing ensure international standards for purity and safety"
    },
    {
      icon: "💰",
      title: "Authentic & Affordable",
      description: "Premium quality at competitive prices - excellent value for traditional, health-conscious families"
    }
  ];
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 mb-20">
      <div className="text-center mb-14">
        <div className="inline-block px-6 py-3 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold text-base sm:text-lg mb-6 shadow-xl">
          ✨ Why Customers Love Us
        </div>
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 mb-4 px-2">
          Why Choose Veer Bharat Mustard Oil?
        </h2>
        <p className="text-lg sm:text-xl md:text-2xl text-gray-700 max-w-3xl mx-auto font-medium px-4">
          Experience the authentic taste, aroma, and health benefits of pure traditional mustard oil
        </p>
      </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
        {features.map((feature, idx) => (
          <motion.div
            ...
            transition={{ delay: idx * 0.1 }}
            whileHover={{ y: -8 }}
            className="p-6 sm:p-8 bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-amber-400"
          >
            <div className="text-5xl sm:text-6xl mb-4">{feature.icon}</div>
            <h3 className="text-xl sm:text-2xl font-black text-gray-900 mb-3">{feature.title}</h3>
...
// Product Variants Grid with Mustard Theme
function ProductVariantsGrid({ products }) {
  const [modalVideo, setModalVideo] = useState(null);
    ...
    <>
      <section className="max-w-7xl mx-auto px-4 sm:px-6 mb-20">
        <div className="text-center mb-14">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-700 max-w-3xl mx-auto font-medium px-4">
            From kitchen essentials to bulk packs - we have the right size for every cooking need
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-10">
          {products.map((product) => (
            ...
            >
              {product.popular && (
                <div className="absolute top-5 right-5 z-10 px-4 sm:px-5 py-2 rounded-full bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs sm:text-sm font-bold shadow-xl">
                  🔥 Best Seller
                </div>
              )}

              <div className="relative h-64 sm:h-80 w-full overflow-hidden bg-gradient-to-br from-amber-50 to-orange-50">
                <img
                  src={product.image}
                  alt={product.name}
                  style={{ width: '100%', height: '100%', objectFit: 'cover' }}
              ...
              <div className="p-5 sm:p-7">
                <div className="text-xs sm:text-sm font-bold text-amber-600 mb-2">{product.size}</div>
                <h3 className="text-xl sm:text-2xl font-black text-gray-900 mb-3 group-hover:text-amber-600 transition-colors">
                  {product.name}
                </h3>
                ...
                <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-6">
                  <span className="text-2xl sm:text-3xl font-black text-amber-600">₹{product.price}</span>
                  {product.originalPrice && (
                ...
                <div className="flex items-center gap-3">
                  <button className="flex-1 text-center rounded-full px-4 sm:px-6 py-3 sm:py-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-base sm:text-lg font-bold shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300">
                    🛒 Add to Cart
                  </button>
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    onClick={() => setModalVideo({ src: product.video, name: product.name })}
                    className="rounded-full px-4 sm:px-5 py-3 sm:py-4 border-2 border-amber-500 text-amber-600 font-bold hover:bg-amber-50 transition-all text-base sm:text-lg"
                  >
                    🎥
                  </motion.button>
                </div>
      ...
      <AnimatePresence>
        {modalVideo && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[300] flex items-center justify-center p-4 sm:p-6 bg-black/80 backdrop-blur-sm"
            onClick={() => setModalVideo(null)}
          >
            <motion.div
              initial={{ scale: 0.9, opacity: 0 }}
            ...
            >
              <button
                onClick={() => setModalVideo(null)}
                className="absolute right-3 sm:right-5 top-3 sm:top-5 z-20 rounded-full bg-white/90 px-4 sm:px-6 py-2 sm:py-3 text-base sm:text-lg font-bold hover:bg-white transition"
              >
                ✕ Close
              </button>
              <video
              ...
              />
              <div className="p-4 sm:p-6 bg-gradient-to-t from-black to-transparent text-white">
                <div className="text-xl sm:text-2xl font-bold">{modalVideo.name}</div>
                <div className="text-base sm:text-lg text-white/80 mt-1">
                  Veer Bharat — Premium Mustard Oil Demo
                </div>
              </div>
            </motion.div>
...
export default function MustardOilPage() {
  return (
    <main style={{ background: "linear-gradient(135deg, #fef3c7 0%, #fde68a 50%, #fbbf24 100%)" }} className="min-h-screen py-6 sm:py-12">
      <div className="max-w-7xl mx-auto px-2 sm:px-6 relative w-full">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="inline-block px-5 sm:px-7 py-3 sm:py-4 rounded-full bg-gradient-to-r from-amber-500 via-orange-500 to-pink-500 text-white font-bold text-base sm:text-xl mb-6 sm:mb-8 shadow-2xl">
              🌾 Veer Bharat Premium Mustard Oil
            </div>
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-black text-gray-900 mb-4 sm:mb-6 leading-tight px-4">
              Traditional Kachi Ghani Perfection
            </h1>
            <p className="text-base sm:text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto font-medium leading-relaxed px-4">
              Pure, cold-pressed mustard oil with authentic aroma and natural goodness for your traditional Indian kitchen
            </p>
          </motion.div>
        </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 mb-12 sm:mb-16">
          <div className="bg-gradient-to-r from-amber-500 via-orange-500 to-pink-500 rounded-3xl p-8 sm:p-12 text-center text-white shadow-2xl">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4 sm:mb-6">Ready for Authentic Cooking?</h2>
            <p className="text-lg sm:text-xl md:text-2xl mb-6 sm:mb-8 max-w-2xl mx-auto">
              Order now and experience the pure, traditional taste of Kachi Ghani mustard oil delivered fresh
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button className="w-full sm:w-auto px-8 sm:px-10 py-4 sm:py-5 rounded-full bg-white text-amber-600 text-lg sm:text-xl font-bold shadow-xl hover:scale-105 transition-all duration-300">
                🛒 Order Now
              </button>
              <button className="w-full sm:w-auto px-8 sm:px-10 py-4 sm:py-5 rounded-full border-2 border-white text-white text-lg sm:text-xl font-bold hover:bg-white/10 transition-all duration-300">
                📞 Contact Us
              </button>
            </div>
          </div>
